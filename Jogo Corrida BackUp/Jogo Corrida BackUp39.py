...
while True:
    ...
    if Y > 480:
        Y = 0
        if Ganhar < 10 or (Ganhar > 14 and Ganhar < 61) or (Ganhar > 70 and Ganhar < 201):
            Y3 = 0
        if Ganhar < 21:
            Y4 = 0
        if Ganhar < 101:
