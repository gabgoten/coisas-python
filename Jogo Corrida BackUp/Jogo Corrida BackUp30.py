#CONTINUAR FAZENDO O CAMINHO ALTERNATIVO (PRECISA FAZER COM QUE A COLISÃO SEJA DETECTADA E O MAPA MUDE PRA ALGO DE LADO MAS DPS VOLTE)
#FAZER OS 2 FINAIS MAIS BONITINHOS
#FAZER COM QUE O SPRITE DELA GIRE HORIZONTALMENTE QUANDO CLICAR ESQUERDA OU DIREITA ENQUANTO CORRE (num sei se faço)
