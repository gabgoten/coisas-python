...
while True:
    ...
    if Ganhar > 60 and Ganhar < 64:
        ...
        pygame.draw.rect(tela, (255, 0, 0), hitbox_caminho)
    if Ganhar >= 64:
    ...
    if mudar_mapa == False and inicio_jogo > 1000:
