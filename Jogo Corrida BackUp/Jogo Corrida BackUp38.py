...
while True:
    ...
    if Y > 480:
        Y = 0
        if Ganhar < 10 or (Ganhar > 14 and Ganhar < 61):
            Y3 = 0
        if Ganhar < 21:
            Y4 = 0
        if Ganhar < 101:
    ...
    if Ganhar > 9 and Ganhar < 13:
        ...
        hitbox_caminho2 = pygame.Rect(635, Y3 - 470, 20, 175)
    if Ganhar >= 13:
        hitbox_caminho2 = pygame.Rect(-500, -500, 0, 0)
    ...
    if mudar_mapa2 == True:
        ...
        hitbox_sair = pygame.Rect(0, 200, 1, 500)
    ...
    if mudar_mapa == False and mudar_mapa2 == False:
        ...
        if hitbox_jogador.colliderect(hitbox_cima3):
            ...
            parou_cima3 = False
    if mudar_mapa == True and mudar_mapa2 == False:
        parou_cima = False
        parou_cima1 = False
        parou_cima2 = False
        parou_cima3 = False
