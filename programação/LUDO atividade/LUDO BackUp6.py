...
def reiniciar():
    ...
    pygame.draw.rect(tela, (verde), ((Largura - Largura) + 5, (Altura // 2) - 5, 25, 10), 0)
    pygame.draw.polygon(tela, (verde), (((Largura - Largura) + 20, (Altura // 2) - 10), (20, (Altura // 2) + 10), (40, (Altura // 2))))
