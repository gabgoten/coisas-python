...
while True:
    ...
    while saguão_menu == True:    
        ...
        hitbox_parede3 = pygame.Rect(saguão_x + 1280, saguão_y, 448, 1039)
        ...
        if hitbox_jogador.colliderect(hitbox_parede1):
            ...
            parede_esquerda = False
        if hitbox_jogador.colliderect(hitbox_parede2):
            parede_cima = True
        else:
            parede_cima = False
        if hitbox_jogador.colliderect(hitbox_parede3):
            parede_direita = True
        else:
            parede_direita = False
        if hitbox_jogador.colliderect(hitbox_parede4):
            parede_baixo = True
        else:
            parede_baixo = False
