...
superficie = pygame.Surface((640, 480), pygame.SRCALPHA)
...
fundo_caminho_virando2 = pygame.transform.scale(fundo_caminho_virando2, (Largura, Altura))
...
while True:
    ...
    while menu == True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
                sys.exit()
        teste = pygame.Rect((235, quadrado_y), (150, 45))
        ...
        if keys[pygame.K_z] and quadrado_y == 285:
            resetar_jogo()
            saguão_menu = True
    ...
    while saguão_menu == True:    
        ...
        if aleatorio_npcs == 1:
            tela.blit(npc_cima, (saguão_x + 150, saguão_y + 200))
            npc_x = saguão_x + 150
            npc_y = saguão_y + 200
            tela.blit(npc_cima2, (saguão_x + 750, saguão_y + 500))
            npc_x2 = saguão_x + 750
            npc_y2 = saguão_y + 500
            tela.blit(npc_cima3, (saguão_x + 80, saguão_y + 800))
            npc_x3 = saguão_x + 80
            npc_y3 = saguão_y + 800
        if aleatorio_npcs == 2:
            tela.blit(npc_cima2, (saguão_x + 150, saguão_y + 200))
            npc_x2 = saguão_x + 150
            npc_y2 = saguão_y + 200
            tela.blit(npc_cima3, (saguão_x + 750, saguão_y + 500))
            npc_x3 = saguão_x + 750
            npc_y3 = saguão_y + 500
            tela.blit(npc_cima, (saguão_x + 80, saguão_y + 800))
            npc_x = saguão_x + 80
            npc_y = saguão_y + 800
        if aleatorio_npcs == 3:
            tela.blit(npc_cima3, (saguão_x + 150, saguão_y + 200))
            npc_x3 = saguão_x + 150
            npc_y3 = saguão_y + 200
            tela.blit(npc_cima, (saguão_x + 750, saguão_y + 500))
            npc_x = saguão_x + 750
            npc_y = saguão_y + 500
            tela.blit(npc_cima2, (saguão_x + 80, saguão_y + 800))
            npc_x2 = saguão_x + 80
            npc_y2 = saguão_y + 800
        if aleatorio_npcs == 4:
            tela.blit(npc_cima, (saguão_x + 150, saguão_y + 200))
        ...
        hitbox_parede1 = pygame.Rect(saguão_x, saguão_y, 510, 352)
        hitbox_parede12 = pygame.Rect(saguão_x, saguão_y, 513, 350)
        hitbox_parede2 = pygame.Rect(saguão_x, saguão_y + 416, 513, 192)
        hitbox_parede3 = pygame.Rect(saguão_x, saguão_y + 672, 513, 228)
        hitbox_parede4 = pygame.Rect(saguão_x, saguão_y + 897, 784, 142)
        hitbox_parede5 = pygame.Rect(saguão_x + 1280, saguão_y, 448, 352)
        hitbox_parede6 = pygame.Rect(saguão_x + 1279, saguão_y + 416, 448, 192)
        hitbox_parede7 = pygame.Rect(saguão_x + 1279, saguão_y + 671, 513, 422)
        hitbox_parede8 = pygame.Rect(saguão_x + 1007, saguão_y + 895, 276, 128)
        hitbox_parede9 = pygame.Rect(saguão_x + 512, saguão_y, 768, 128)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede2)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede3)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede4)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede5)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede6)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede7)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede8)
        pygame.draw.rect(tela, (255, 0, 0), hitbox_parede9)
        ...
        if hitbox_jogador.colliderect(hitbox_parede1) or hitbox_jogador.colliderect(hitbox_parede2):
            parede_baixo = True
        else:
            parede_baixo = False
        if hitbox_jogador.colliderect(hitbox_parede12):
            parede_direita = True
        else:
            parede_direita = False
        ...
        if continuar_texto == False:
            if keys[pygame.K_LEFT] and saguão_x <= 0 and personagem_x == Largura/2 - 30 and parede_direita == False:
                saguão_x += 2
                olhando = 1
            if keys[pygame.K_RIGHT] and saguão_x >= -1152 and personagem_x == Largura/2 - 30:
                saguão_x -= 2
                olhando = 2
            if keys[pygame.K_UP] and saguão_y <= 0 and personagem_y == Altura/2 - 30 and parede_baixo == False:
                saguão_y += 2
                olhando = 3
            ...
            if saguão_x >= 0 or saguão_x <= -1152:
                if keys[pygame.K_LEFT] and personagem_x > 15 and parede_direita == False:
                    personagem_x -= 1.5
                    olhando = 1
                if keys[pygame.K_RIGHT] and personagem_x < 555:
                    personagem_x += 1.5
                    olhando = 2
            if saguão_y >= 0 or saguão_y <= -515:
                if keys[pygame.K_UP] and personagem_y > -15 and parede_baixo == False:
                    personagem_y -= 1.5
                    olhando = 3
                if keys[pygame.K_DOWN] and personagem_y < 395:
                    personagem_y += 1.5
                    olhando = 0
        pygame.display.update()
    ...
    if Ganhar > 100 and Ganhar < 104:
        ...
        tela.blit(fundo_caminho_virando2, (X, Y5 - 480))
    if Y > 480:
        Y = 0
        if Ganhar < 21:
            Y4 = 0
