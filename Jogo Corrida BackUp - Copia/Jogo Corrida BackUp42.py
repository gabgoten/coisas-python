...
fundo_caminho3 = pygame.image.load("fundo_caminho3.png")
fundo_caminho3 = pygame.transform.scale(fundo_caminho3, (Largura, Altura))

fundo_caminho4 = pygame.image.load("fundo_caminho4.png")
fundo_caminho4 = pygame.transform.scale(fundo_caminho4, (Largura, Altura))
...
hitbox_caminho2 = pygame.Rect(635, Y3 - 470, 20, 175)
...
while True:
    ...
    if Y > 480:
        Y = 0
        if Ganhar < 10 or (Ganhar > 14 and Ganhar < 61) or (Ganhar > 70 and Ganhar < 121):
            Y3 = 0
        if Ganhar < 21:
            Y4 = 0
        if Ganhar < 101:
    ...
    if Ganhar > 60 and Ganhar < 64:
        tela.blit(fundo_caminho3, (X, Y3 - 490))
        hitbox_caminho = pygame.Rect(635, Y3 - 420, 20, 175)

    if Ganhar > 120 and Ganhar < 124:
        tela.blit(fundo_caminho1, (X, Y3 - 490))
        hitbox_caminho2 = pygame.Rect(635, Y3 - 470, 20, 175)
    ...
    if mudar_mapa2 == True:
        ...
        if mudou2 == True:
            ...
            personagem_y = 200
            mudou2 = False
        tela.blit(fundo_caminho4, (0, 0))
        hitbox_sair = pygame.Rect(0, 100, 1, 600)
    if mudar_mapa2 == False:
        hitbox_sair = pygame.Rect(-500, -500, -500, -500)
        mudou2 = True
    ...
    if mudar_mapa == False and mudar_mapa2 == False:
    ...
    if mudar_mapa == False and mudar_mapa2 == False and inicio_jogo <= 300:
    ...
    if mudar_mapa == False and mudar_mapa2 == False:
        ...
        if hitbox_jogador.colliderect(hitbox_cima3):
            ...
            parou_cima3 = False
    if mudar_mapa == True or mudar_mapa2 == True:
        parou_cima = False
        parou_cima1 = False
        parou_cima2 = False
        parou_cima3 = False
    ...
    if hitbox_jogador.colliderect(hitbox_caminho2):
        mudar_mapa2 = True
    ...
    if hitbox_jogador.colliderect(hitbox_sair):
        olhando = 1
        personagem_x = posição_momentox - 10
        personagem_y = posição_momentoy
        mudar_mapa2 = False

    keys = pygame.key.get_pressed()
    if mudar_mapa == False and mudar_mapa2 == False and inicio_jogo > 500:
    ...
    if mudar_mapa == False and mudar_mapa2 == False and inicio_jogo > 1000:
...
#    pygame.draw.rect(tela, (0, 255, 0), (BarraVerde), 0)
    ...
    if mudar_mapa2 == False:
        posição_momentox = personagem_x
        posição_momentoy = personagem_y
